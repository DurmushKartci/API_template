...
exports.matematik_sorusu = void 0;
const Ders_1 = require("./Ders");
const Konu_1 = require("./Konu");
const Soru_1 = require("./Soru");
/////////////// DERSLER ///////////////
let matematik = new Ders_1.Ders("Matematik");
let turkce = new Ders_1.Ders("Türkçe");
let fizik = new Ders_1.Ders("Fizik");
let kimya = new Ders_1.Ders("Kimya");
let biyoloji = new Ders_1.Ders("Biyoloji");
let tarih = new Ders_1.Ders("Tarih");
/////////////// KONULAR ///////////////
let yas_problemi = new Konu_1.Konu(matematik, "Yaş Problemi");
...
let hareket_hiz = new Konu_1.Konu(fizik, "Hareket-Hız");
...
/////////////// SORULAR ///////////////
exports.matematik_sorusu = new Soru_1.Soru(matematik, yas_problemi);
// let turkce_sorusu       = new Soru(turkce,yazim_kurallari)
let fizik_sorusu = new Soru_1.Soru(fizik, hareket_hiz);
